...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__90FC1F1",
    appName: "Replace",
    appVersion: "1.0.0",
    appVersionCode: "100",
    appLanguage: getAppLanguage(hostLanguage),
    uniCompileVersion: "4.86",
    uniCompilerVersion: "4.86",
    uniRuntimeVersion: "4.86",
...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.25,198.18.0.1";
  const port = "8090";
  const id = "mp-weixin_keZqNj";
